...
import com.example.bugtracker.exception.directmessageconcretes.InvalidSprintDateException;
...
class SprintTest {
    ...
    @Test
    void createSprint_createsAndReturnsSprint_givenFieldValuesWithValidDates() {
        /*
    ...
    void createSprint_throwsException_givenInvalidDates() {
        /*
         * Verifies that the 'createSprint' method throws an exception
    ...
    @Test
    void update_updatesAnsReturnsUpdatedSprint_givenUpdatedFieldValues() {
        /*
    ...
    @Test
    void update_throwsException_givenStartDateLaterThanEndDate() {
        /*
         * Verifies that the 'update' method throws an exception
         * when the 'endDate' argument date is earlier than the 'startDate' argument date.
         */
    ...
    @Test
    void completeSprint_archivesSprint_givenEndDateInThePast() {
        /*
    ...
    @Test
    void completeSprint_givenEndDateInTheFuture() {
        /*
         * Verifies that the 'completeSprint' method sets 'archived' field to true.
