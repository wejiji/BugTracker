package com.example.bugtracker.integrationtest.authcontroller;
...
import com.example.bugtracker.integrationtest.methodsecurity.TestMethodSecurityController;
...
class AuthControllerTest {
    ...
    void authController_logoutSuccess_givenRefreshToken() throws Exception {
        ...
        //Execution & Assertioins
        mvc.perform(MockMvcRequestBuilders.post("/logout-user")
                .cookie(refreshToken))
                .andDo(print())
                .andExpect(status().isOk());
