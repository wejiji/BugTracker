...
import com.example.security2pro.service.authentication.JwtTokenManagerImpl;
...
class JwtTokenManagerImplImplTest {
    ...
    private com.example.security2pro.service.authentication.JwtTokenManager jwtTokenManager
            = new JwtTokenManagerImpl(signingKey,clock,accessMaxAgeInMins,projectRolesConverter,projectMemberRepository);
    ...
    public void createAccessToken(){
        ...
        assertEquals("["+ projectIdForAuthorization +":ROLE_PROJECT_MEMBER]",claims.get("projectRoles"));
    }
