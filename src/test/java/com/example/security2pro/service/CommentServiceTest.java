...
public class CommentServiceTest {
    ...
    @Test
    public void testCommentCreateDto(){

        CommentCreateDto commentCreateDto = new CommentCreateDto(1L,"comment description");
    ...
    @Test
    public void testCommentDtoFromParams(){
    ...
    public void createComment(){
        ...
        CommentCreateDto commentCreateDto = new CommentCreateDto(issue.getId(),"comment on the issue");

        //Execution
        CommentCreateDto commentCreateDtoReturned = commentService.createComment(commentCreateDto);


        //Assertions
        assertThat(commentCreateDtoReturned).usingRecursiveComparison().isEqualTo(commentCreateDto);
