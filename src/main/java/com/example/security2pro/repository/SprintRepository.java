...
public interface SprintRepository extends JpaRepository<Sprint,Long> {
    ...
    public Set<Sprint> findByProjectIdAndArchivedTrue(@Param("projectId") Long projectId);

    public Set<Sprint> findByProjectIdAndArchivedFalse(@Param("projectId") Long projectId);
