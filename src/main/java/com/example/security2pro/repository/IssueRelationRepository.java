...
//    @Query("select ir from IssueRelation ir where ir.affectedIssue.id=:issueId and ir.id in(:ids)")
//    Set<IssueRelation> findAllByIdAndAffectedIssue(@Param("ids") Iterable<Long> ids, @Param("issueId") Long issueId);
//
