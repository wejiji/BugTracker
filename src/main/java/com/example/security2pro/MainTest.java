...
//        Set<ProjectMember> projectMembers= projectService.findAllMemberByProjectIdWithUser(projectId);
//        Set<Sprint> sprints = projectService.findActiveProjectSprints(projectId);
//        Set<Issue> issuesWithSprint = projectService.findActiveProjectIssuesWithSprint(projectId);
//        Set<Issue> issuesWithoutSprint= projectService.findActiveProjectIssuesWithoutSprint(projectId);
//
//        ProjectDto projectDto = new ProjectDto(newProject,projectMembers,sprints, issuesWithSprint ,issuesWithoutSprint);
...
//
//
//        Issue issue1 = new Issue(1L, newProject, new HashSet<>(Arrays.asList(user1)), "issue1", "complete this project", LocalDateTime.now().plus(14, ChronoUnit.DAYS)
...
//
////        Assignment assignment1 = new Assignment(user1,issue1);
////        Assignment assignment2 = new Assignment(user1,issue2);
////        Assignment assignment3 = new Assignment(user1,issue3);
////
////        issue1.addAssignment(assignment1);
////        issue2.addAssignment(assignment2);
////        issue3.addAssignment(assignment3);
//
//
//
...
//
//        Sprint sprint =sprintRepository.save(sprint1); // when sprint1 is not persisted, issue couldn't save the sprint.
//        issue1.assignCurrentSprint(sprint);
//
...
//        em.flush();
//        //flush before querying DB
//        projectMembers= projectService.findAllMemberByProjectIdWithUser(projectId);
//        sprints = projectService.findActiveProjectSprints(projectId);
//        issuesWithSprint = projectService.findActiveProjectIssuesWithSprint(projectId);
//        issuesWithoutSprint= projectService.findActiveProjectIssuesWithoutSprint(projectId);
//
//        projectDto = new ProjectDto(newProject,projectMembers,sprints, issuesWithSprint ,issuesWithoutSprint);
//        System.out.println(projectDto);
//
//
//        issue1.changeStatus(IssueStatus.DONE);
//        HashSet<Issue> issues = new HashSet<>();
//        issues.add(issue1); issues.add(issue2); issues.add(issue3);
//        sprint1.completeSprint();
//        sprintService.handleEndingSprintIssues(sprint1,issues,Collections.emptyMap());
//
//        em.flush();
//        projectMembers= projectService.findAllMemberByProjectIdWithUser(projectId);
//        sprints = projectService.findActiveProjectSprints(projectId);
...
//        System.out.println(projectDto);
//
//        List<SprintIssueHistory> sprintIssueHistoryList= (ArrayList<SprintIssueHistory>) sprintIssueHistoryRepository.findByArchivedSprint(sprint1.getId());
//
//        System.out.println(sprintIssueHistoryList);
//
//        return projectDto;
//    }
//
...
//    public List<IssueDto> testIssueDto2() throws InvocationTargetException, IllegalAccessException {
//        User user1 = new User("mj", passwordEncoder.encode("123"), "Mija", "Lee", "lmj@gmail.com"
//                , Set.of(Role.valueOf("ROLE_TEAM_LEAD")), true);
...
//
//
//        IssueDto issueDto1 = new IssueDto(issue1,Collections.emptySet(),Collections.emptySet());
//        IssueDto issueDto2 = new IssueDto(issue2,Collections.emptySet(),Collections.emptySet());
//        IssueDto issueDto3 = new IssueDto(issue3,Collections.emptySet(),Collections.emptySet());
//        issueDto1=issueService.createIssueFromDto(newProject.getId(), issueDto1);
//        issueDto2=issueService.createIssueFromDto(newProject.getId(), issueDto2);
//        issueDto3=issueService.createIssueFromDto(newProject.getId(), issueDto3);
//
//
...
//        em.flush();
//
//        issueDto1 = new IssueDto(issue1,Collections.emptySet(),Set.of(issueRelation1,issueRelation2));
