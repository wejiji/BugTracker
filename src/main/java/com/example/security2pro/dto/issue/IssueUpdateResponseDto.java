...
public class IssueUpdateResponseDto {
    ...
    public IssueUpdateResponseDto(Issue issue, Set<Activity> activities, Set<IssueRelation> issueRelationList, List<IssueHistoryDto> issueHistoryDtoList){
        issueId = issue.getId();
