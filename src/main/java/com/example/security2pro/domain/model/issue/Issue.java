...
//    // 끝난 이후에는 endDate 로 쓰는것이 맞을듯
    ...
    public void addIssueRelation(IssueRelation issueRelationArg){
        /* jpa automatically updates 'ISSUERELATION' table in DB
        * when 'issueRelation' collection field is modified
    ...
    public void addComment(Comment comment){
        ...
        // Comment's 'id' field is never updated
        // and all comments are assigned autogenerated keys from DB
    ...
    public void endIssueWithProject(){
        /*called when an issue is archived along with the ending project it belongs to
        */
        currentSprint = null;
        archived = true;
    }
    ...
    public void assignCurrentSprint(Sprint sprint){
        if(sprint!=null && sprint.isArchived()) {
            throw new IllegalArgumentException("'currentSprint' can't be assigned an archived sprint");
        }
